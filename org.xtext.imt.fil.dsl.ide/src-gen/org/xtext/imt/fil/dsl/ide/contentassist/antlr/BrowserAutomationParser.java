...
public class BrowserAutomationParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BrowserAutomationGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGetAccess().getAlternatives_3_0_2_0_3(), "rule__Get__Alternatives_3_0_2_0_3");
			...
			builder.put(grammarAccess.getBrowserAutomationAccess().getWebBrowserAssignment_2(), "rule__BrowserAutomation__WebBrowserAssignment_2");
			builder.put(grammarAccess.getBrowserAutomationAccess().getStatementsAssignment_3(), "rule__BrowserAutomation__StatementsAssignment_3");
			...
			builder.put(grammarAccess.getGetAccess().getAttrValAssignment_3_0_2_0_3_0(), "rule__Get__AttrValAssignment_3_0_2_0_3_0");
			builder.put(grammarAccess.getGetAccess().getAttrVarAssignment_3_0_2_0_3_1(), "rule__Get__AttrVarAssignment_3_0_2_0_3_1");
			builder.put(grammarAccess.getGetAccess().getVarRefAssignment_3_0_2_1_1(), "rule__Get__VarRefAssignment_3_0_2_1_1");
			...
			builder.put(grammarAccess.getInsertAccess().getValAssignment_1_0(), "rule__Insert__ValAssignment_1_0");
			...
			builder.put(grammarAccess.getChooseAccess().getVarAssignment_3(), "rule__Choose__VarAssignment_3");
			builder.put(grammarAccess.getContainsAccess().getVarAssignment_0(), "rule__Contains__VarAssignment_0");
			builder.put(grammarAccess.getContainsAccess().getVar2Assignment_2(), "rule__Contains__Var2Assignment_2");
		}
	}
