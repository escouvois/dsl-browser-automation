...
public class BrowserAutomationParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BrowserAutomationGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTestAccess().getStatementsAssignment_3(), "rule__Test__StatementsAssignment_3");
			builder.put(grammarAccess.getStatementAccess().getActionAssignment_0_1(), "rule__Statement__ActionAssignment_0_1");
			builder.put(grammarAccess.getStatementAccess().getUrlAssignment_3_2(), "rule__Statement__UrlAssignment_3_2");
			...
			builder.put(grammarAccess.getInsertAccess().getVarAssignment_1(), "rule__Insert__VarAssignment_1");
