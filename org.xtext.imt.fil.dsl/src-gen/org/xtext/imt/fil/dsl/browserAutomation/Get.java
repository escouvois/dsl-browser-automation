 ...
 *   <li>{@link org.xtext.imt.fil.dsl.browserAutomation.Get#getAttrVar <em>Attr Var</em>}</li>
...
public interface Get extends Statement
{
  ...
  /**
   * Returns the value of the '<em><b>Attr Var</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Attr Var</em>' containment reference.
   * @see #setAttrVar(VarReference)
   * @see org.xtext.imt.fil.dsl.browserAutomation.BrowserAutomationPackage#getGet_AttrVar()
   * @model containment="true"
   * @generated
   */
  VarReference getAttrVar();

  /**
   * Sets the value of the '{@link org.xtext.imt.fil.dsl.browserAutomation.Get#getAttrVar <em>Attr Var</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Attr Var</em>' containment reference.
   * @see #getAttrVar()
   * @generated
   */
  void setAttrVar(VarReference value);
