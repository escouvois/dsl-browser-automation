...
public class BrowserAutomationPackageImpl extends EPackageImpl implements BrowserAutomationPackage
{
   ...
   */
  @Override
  public EReference getGet_AttrVar()
  {
   ...
   */
  @Override
  public EReference getCheck_Var()
  {
   ...
   */
  @Override
  public EReference getChoose_Var()
  {
   ...
   */
  @Override
  public EReference getContains_Var()
  {
   ...
   */
  @Override
  public EReference getContains_Var2()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(getEClass, GET__ATTR_VAR);
    ...
    createEReference(checkEClass, CHECK__VAR);

    chooseEClass = createEClass(CHOOSE);
    createEAttribute(chooseEClass, CHOOSE__VALUE);
    createEReference(chooseEClass, CHOOSE__VAR);

    containsEClass = createEClass(CONTAINS);
    createEReference(containsEClass, CONTAINS__VAR);
    createEReference(containsEClass, CONTAINS__VAR2);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getGet_AttrVar(), this.getVarReference(), null, "attrVar", null, 0, 1, Get.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getGet_VarRef(), this.getVarReference(), null, "varRef", null, 0, 1, Get.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getCheck_Var(), this.getVarReference(), null, "var", null, 0, 1, Check.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getChoose_Var(), this.getVarReference(), null, "var", null, 0, 1, Choose.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(containsEClass, Contains.class, "Contains", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getContains_Var(), this.getVarReference(), null, "var", null, 0, 1, Contains.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getContains_Var2(), this.getVarReference(), null, "var2", null, 0, 1, Contains.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
